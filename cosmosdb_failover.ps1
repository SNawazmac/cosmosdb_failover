...
Update-AzCosmosDBAccountFailoverPriority -ResourceGroupName $cosmosdb_resource_group_name -Name $cosmosdb_name -FailoverPolicy $cosmosdb_secondary_region, $cosmosdb_primary_region
